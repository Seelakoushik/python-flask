...
root@ip-172-31-7-58:/home/ubuntu# ls
Dockerfile  clusterip.yml  deployment.yml  loadbalancer.yml      namespace.yml  pod.yml  secret.yml
app.py      config.yml     hospital-chart  minikube-linux-amd64  nodeport.yml   pv.yml
root@ip-172-31-7-58:/home/ubuntu# cat Dockerfile
# =========================
# Build Stage
# =========================
